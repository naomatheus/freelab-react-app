	...
	render(){
		return(
			...
			<div className='bizStructure'>
				...
				Deciding the structure of your business can be a tough decision, but just remember not to overcomplicate thing.</p>
				<BizCard><h4>LLC - Limited Liability Company</h4>
